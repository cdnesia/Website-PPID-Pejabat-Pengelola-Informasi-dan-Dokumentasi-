...
return [
    ...
    */
    ...
    'between' => [
        ...
        'file' => ':attribute harus memiliki ukuran antara :min sampai :max kilobita.',
    ...
    'contains' => ':attribute tidak menyertakan nilai yang wajib ada.',
    ...
    */
    ...
    'attributes' => [
        ...
        'request_number' => 'nomor permohonan',
        'reason' => 'alasan',
        'status' => 'status',
        'slug' => 'slug',
    ],
